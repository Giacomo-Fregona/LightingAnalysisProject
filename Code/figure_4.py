...
for i in range(3):
	...
	#Y and X
	axes[i].plot(l1m1Q50Y[i], l1m1Q50X[i], c=[0, 0, 1, 1], marker="o", label="l(1,-1)")
	axes[i].plot(l10Q50Y[i], l10Q50X[i], c=[1, 0, 0, 1], marker="o", label="l(1,0)")
	axes[i].plot(l11Q50Y[i], l11Q50X[i], c=[1, 0.9, 0.1, 1], marker="o", label="l(1,1)")
	axes[i].plot(l2m2Q50Y[i], l2m2Q50X[i], c=[1, 0, 1, 1], marker="o", label="l(2,-2)")
	axes[i].plot(l2m1Q50Y[i], l2m1Q50X[i], c=[0, 1, 0, 1], marker="o", label="l(2,-1)")
	axes[i].plot(l20Q50Y[i], l20Q50X[i], c=[0, 1, 1, 1], marker="o", label="l(2,0)")
	axes[i].plot(l21Q50Y[i], l21Q50X[i], c=[0.7, 0, 0, 1], marker="o", label="l(2,1)")
	axes[i].plot(l22Q50Y[i], l22Q50X[i], c=[0.5, 0.5, 0.5, 1], marker="o", label="l(2,2)")


	lines = []
	c = []
	# Y and X
	lines.append([(l1m1Q35Y[i], l1m1Q50X[i]), (l1m1Q65Y[i], l1m1Q50X[i])])
	lines.append([(l1m1Q50Y[i], l1m1Q35X[i]), (l1m1Q50Y[i], l1m1Q65X[i])])
	c.append([0, 0, 1, 1])
	c.append([0, 0, 1, 1])
	lines.append([(l10Q35Y[i], l10Q50X[i]), (l10Q65Y[i], l10Q50X[i])])
	lines.append([(l10Q50Y[i], l10Q35X[i]), (l10Q50Y[i], l10Q65X[i])])
	c.append([1, 0, 0, 1])
	c.append([1, 0, 0, 1])
	lines.append([(l11Q35Y[i], l11Q50X[i]), (l11Q65Y[i], l11Q50X[i])])
	lines.append([(l11Q50Y[i], l11Q35X[i]), (l11Q50Y[i], l11Q65X[i])])
	c.append([1, 0.9, 0.1, 1])
	c.append([1, 0.9, 0.1, 1])
	lines.append([(l2m2Q35Y[i], l2m2Q50X[i]), (l2m2Q65Y[i], l2m2Q50X[i])])
	lines.append([(l2m2Q50Y[i], l2m2Q35X[i]), (l2m2Q50Y[i], l2m2Q65X[i])])
	c.append([1, 0, 1, 1])
	c.append([1, 0, 1, 1])
	lines.append([(l2m1Q35Y[i], l2m1Q50X[i]), (l2m1Q65Y[i], l2m1Q50X[i])])
	lines.append([(l2m1Q50Y[i], l2m1Q35X[i]), (l2m1Q50Y[i], l2m1Q65X[i])])
	c.append([0, 1, 0, 1])
	c.append([0, 1, 0, 1])
	lines.append([(l20Q35Y[i], l20Q50X[i]), (l20Q65Y[i], l20Q50X[i])])
	lines.append([(l20Q50Y[i], l20Q35X[i]), (l20Q50Y[i], l20Q65X[i])])
	c.append([0, 1, 1, 1])
	c.append([0, 1, 1, 1])
	lines.append([(l21Q35Y[i], l21Q50X[i]), (l21Q65Y[i], l21Q50X[i])])
	lines.append([(l21Q50Y[i], l21Q35X[i]), (l21Q50Y[i], l21Q65X[i])])
	c.append([0.7, 0, 0, 1])
	c.append([0.7, 0, 0, 1])
	lines.append([(l22Q35Y[i], l22Q50X[i]), (l22Q65Y[i], l22Q50X[i])])
	lines.append([(l22Q50Y[i], l22Q35X[i]), (l22Q50Y[i], l22Q65X[i])])
